    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex item-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`}>
                <a href='#top'>
                    <h1 style={{ fontSize: "30px", fontWeight: "600", marginTop: "6px" }} className='w-58 cursor-pointer mr-14'>Mohd Faiz</h1>
                </a>
                ...
                <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500'>
                    ...
                    <li> <a onClick={closeMenu} href="#project">My Project</a></li>
